...
window.configure(fg_color='#fac6c6')
...
carnival_frame = ctk.CTkFrame(window, fg_color='#fac6c6')
...
tagline_label = ctk.CTkLabel(carnival_frame, text="Tag along and create...", font=("Times", 36,'italic'), fg_color='#fac6c6', bg_color='#333333',text_color='black')
