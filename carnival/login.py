...
login_label = ctk.CTkLabel(frame,text='USER LOGIN',bg_color='#fac6c6',font=("Times", 40,'italic','underline'),text_color='black')
...
login_btn = ctk.CTkButton(frame,text='LOGIN',fg_color="#FF3399",command= login,text_color='white',font=('Arial',15,'bold'),corner_radius=100,width=80,border_width=3,border_color='black')
